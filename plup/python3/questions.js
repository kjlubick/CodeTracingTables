...
},
{
  ...
  code: `add_gift_wrap = input("Gift wrap? ") == "yes"
...
print(total / denom)`,
  ...
  answer: {
    ...
    grades: ['[40,20,90]'],
    total: ['-','0','0','0','60','60','60','90','90','90','210'],
    grade: ['-','-','40','40','40','20','20','20','90'],
    adjusted: ['-','-','-','60','60','60','30','30','30','120'],
    denom: ['-','-','-','-','-','-','-','-','-','-','-','-','3'],
  },
  solved_piece: "SYB",
},
{
  ...
  code: `gatherer = 0
for stepper in range(10, 20, 3):
    gatherer += stepper
    gatherer = gatherer // 3
gatherer = 10 - gatherer`,
  vars: 2, 
  max_steps: 15,
  answer: {
    line: ['1','2','3','4','2','3','4','2','3','4',
    '2','3','4','2','5'],
    gatherer: ['0','0','10','3','3','16','5','5',
    '21','7','7','26','8','8','2'],
    stepper: ['-','10','10','10','13','13','13',
    '16','16','16','19','19','19'],
  },
  solved_piece: "KTH",
},{
...
tertiary()`,
  ...
  max_steps: 32,
  answer: {
    line: ['1','5','9','12','1','2','5','6',
    '9','10','7','9','10','3','5','6','9','10',
    '7','9','10','13','5','6','9','10',
    '7','9','10','14','9','10'],
  },
  solved_piece: "R8G",
},{
  name: "Function Practice 2",
